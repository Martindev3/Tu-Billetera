...
var SwipeableListItem = function(_PureComponent) {
  ...
  _createClass(SwipeableListItem2, [{
    ...
    key: "render",
    value: function render() {
      var _this$props4 = this.props, children = _this$props4.children, className = _this$props4.className, leadingActions = _this$props4.leadingActions, trailingActions = _this$props4.trailingActions, onClick = _this$props4.onClick;
      return import_react.default.createElement("div", {
        className: clsx("swipeable-list-item", className),
        ref: this.bindWrapperElement,
        onClick: this.leadingActionsOpened || this.trailingActionsOpened ? void 0 : onClick
